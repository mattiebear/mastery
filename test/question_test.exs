defmodule QuestionTest do
  ...
  test "building creates asked question" do
    question = build_question(generators: addition_generators([1], [2]))
  ...
  test "a random choice is made from list generators" do
    ...
    assert eventually_matched(generators, 1)
    assert eventually_matched(generators, 9)
  end

  def eventually_matched(generators, answer) do
