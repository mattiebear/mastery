defmodule Mastery.Boundary.TemplateValidator do
  ...
  def errors(_fields), do: [{nil, "A keyword list of ields is required"}]
  ...
  def validate_raw(_raw), do: {:error, "can't be blank"}
  ...
  def validate_generator(_generator), do: {:error, "must be a list or function"}
